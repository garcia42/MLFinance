...
def multi_indicators(df: pd.DataFrame, n_markets: int, do_all=False, lookback=252) -> tuple[pd.DataFrame, JANUS, CompVar, list]:
    """
    ...
    if do_all:
        ...
        output, _, _, _, _ = cv.compute(
            var_num=VAR_ABS_RATIO,
            param1=lookback,  # 1 year lookback
        ...
        out_df['ABS_RAT_lookback'] = output
    ...
    return out_df, janus, cv, market_names
